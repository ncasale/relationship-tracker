...
export class FightService {
    ...
    addFight(fight: Fight) {
        ...
        //Create request
        return this.http.post('http://52.91.114.12:3000/fight/add' + token, body, {headers:headers})
    ...
    getFights(relationshipId: string) {
        ...
        const token = this.getToken();
        //Create request
        return this.http.post('http://52.91.114.12:3000/fight/getfights/' + relationshipId + token, body, {headers:headers})
            .map((response: Response) => {
    ...
    editFight(fight: Fight) {
        ...
        const token = this.getToken();
        //Create request
        return this.http.patch('http://52.91.114.12:3000/fight/edit' + token, body, {headers:headers})
            .map((response: Response) => {
                return response.json().obj;
            })
            .catch((error: Response) => {
    ...
    deleteFight(fightId: string) {
        ...
        const token = this.getToken();
        //Create request
        return this.http.delete('http://52.91.114.12:3000/fight/delete/' + fightId + token, {headers:headers})
            .map((response: Response) => {
                return response.json().obj;
            })
            .catch((error: Response) => {
    ...
    getFight(fightId: string) {
        ...
        const token = this.getToken();
        //Create request
        return this.http.post('http://52.91.114.12:3000/fight/checkUserSubmittedInfo/' + fightId + token, body, {headers:headers})
            .map((response: Response) => {
